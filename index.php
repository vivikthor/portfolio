  ...
  <body>
    ...
    <nav id="nav">
      <div class="navmenu">
        <ul class="anchor">
          ...
          <li class="deg-der"><a href="#footer">HOLA ITEM 3</a></li>
        </ul>
    ...
    <section id="definicion">
      <span class="definicion">
        <dfn><strong><span class="asterisco">*</span>creativo/a:</strong></dfn>
        <ol>
          <li>
            <b>adj.</b>
            <i>Que posee la capacidad de imaginación y da forma a sus ideas a
              través del medio que le resulte más conveniente.</i
            >
          </li>
        </ol>
      </span>
    ...
    <script src="js/pilotak.js"></script>
